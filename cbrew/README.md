...
and memory. This is achieved through careful tuning using the C programing language to not only control for 
gargbage collection, but also to ensure maximum performance for elected library features.

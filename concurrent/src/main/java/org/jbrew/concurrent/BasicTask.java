 ...
 * <br><br>
 * For an object blocking implementation of a {@link org.jbrew.concurrent.AbstractBlockingTask} (similar to a {@link java.util.concurrent.Callable}, please see:
 * {@link org.jbrew.concurrent.ObjectBlockingTask} and {@link org.jbrew.concurrent.MethodBlockingTask}.
 * @author nealk
 *
 */
public abstract class BasicTask extends AbstractBlockingTask<Void>{

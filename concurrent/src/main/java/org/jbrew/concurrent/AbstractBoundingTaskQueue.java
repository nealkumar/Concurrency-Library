...
/**
 * A {@link AbstractBoundingTaskQueue} provides a skeletal implementation of the {@link org.jbrew.concurrent.TaskQueue} interface.
 ...
 *
 */
public abstract class AbstractBoundingTaskQueue implements TaskQueue<Task<?>>{

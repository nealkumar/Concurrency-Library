...
# Native JBrew Validator
The 'Validator' module is a set of various operations which test your cloud or local machine for compatability with
the Native JBrew library modules. For production enviornments, this type of integration is <i>essential</i> for ensuring full
system operability. Note that the library was developed in a Red Hat Enterprise Linux 8.2 enviornment, with OpenJDK 1.8.x,
and has been safely tested on: Fedora, CentOS, and Ubuntu during beta integration testing. 
